...
#     # A numeração dos pinos precisa ser avaliada na hora
...
#         for key in reading:
#             # Caso um dado da leitura esteja fora dos limites adiciona essa informaçao ao erro
...
# 		# Caso exista um erro
#         if(readingError):
#             # TODO - Adicionar publisher MQTT

#             err['mensagem'] = " | ".join(err['mensagem']) # Junta todas as mensagens em uma string unica separada por " | "
#             err['lido_em'] = lido_em
            
# 			# TODO - USAR FUNÇÕES ASSÍNCRONAS PARA EVITAR GARGALOS
# 			# Enviando o erro para o banco de dados e recebendo o status da requisição
#             status = postError(err).status_code 
